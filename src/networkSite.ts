...
export function initNetworkExpress(app: Express) {
        ...
        */
        ...
        app.post("/api/account/profile/set", checkAccess, async (req, res) => {
            try {
                ...
                await setPlayerBio(id, req.body.bio, Number.parseInt(req.body.hue), req.body.country, Number.parseInt(req.body.hue2));
                res.sendStatus(200);
            }
            catch (exc: any) {
                res.status(400).json({
